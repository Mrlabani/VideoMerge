...
async def start_handler(bot: Client, m: Message):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Developer - @x_04i", url="https://t.me/x_04i")],
                [InlineKeyboardButton("Support Group", url="https://t.me/Labani_Botz"),
                 InlineKeyboardButton("Bots Channel", url="https://t.me/LAbani_Botz")],
    ...
    if "mergeNow" in cb.data:
        ...
        if Config.UPDATES_CHANNEL:
            try:
                ...
                await cb.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://t.me/Labani_Botz).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
        await cb.message.edit(
            text=Config.START_TEXT,
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer - @x_04i", url="https://t.me/x_04i"), InlineKeyboardButton("Support Group", url="https://t.me/LAbani_Botz")], [InlineKeyboardButton("Bots Channel", url="https://t.me/LAbani_Botz")]]),
            disable_web_page_preview=True
        )
        ...
        if (QueueDB.get(cb.from_user.id, None) is None) or (QueueDB.get(cb.from_user.id) == []):
            await cb.answer("Sorry Unkil, Your Queue is Empty!", show_alert=True)
            return
        merged_vid_path = f"{Config.DOWN_PATH}/{str(cb.from_user.id)}/[@x_04i]_Merged.{FormtDB.get(cb.from_user.id).lower()}"
